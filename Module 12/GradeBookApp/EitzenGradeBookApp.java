...
public class EitzenGradeBookApp extends Application{
   ...
   */
   ...
   public void start(Stage primaryStage){
      ...
      primaryStage.setMaxWidth(636); // Any wider than this is wasted space.
      primaryStage.setHeight(636); // Arbitrary number to allow for a few adds before needing to scroll
      primaryStage.show();
   } // End Start(Stage)
   ...
   // The following loads from a CSV file. Uses Student class to get an array of students and transforms into the Gradebook.s
