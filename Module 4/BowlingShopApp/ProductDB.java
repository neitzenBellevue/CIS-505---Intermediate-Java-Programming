...
public class ProductDB {
    ...
    /*
     * The following takes a String code and compares it to expected values. Returns a filled GenericQueue if applicable, otherwise returns an empty GenericQueue.
     * @param code String
     */
    public static GenericQueue<Product> getProducts(String code){
        if (code.equals("b")){
            // The following sections create unique balls and sets all fields.
            Ball ball1 = new Ball();
            ball1.setCode("B100");
            ...
            // The following creates a GenericQueue and fills it with the ball objects. Returns the GenericQueue
            ...
            balls.enqueue(ball5);
            return balls;
        } // End equals.("b") if statement
        else if (code.equals("s")){
            // The following sections create unique shoes and sets all fields.
            Shoe shoe1 = new Shoe();
            shoe1.setCode("S100");
            ...
            shoes.enqueue(shoe5);
            return shoes;
        }// End equals.("s") else if statement
        else if (code.equals("a")){
            // The following sections create unique bags and sets all fields.
            Bag bag1 = new Bag();
            bag1.setCode("A100");
            ...
            GenericQueue<Product> generic = new GenericQueue<Product>();
            return generic;
        } // End else
    } // End getProducts(String)
} // End ProductDB
